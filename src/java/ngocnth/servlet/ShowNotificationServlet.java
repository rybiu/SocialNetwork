...
import ngocnth.notification.NotificationDetail;
...
public class ShowNotificationServlet extends HttpServlet {
    ...
    private static final Logger LOGGER = LogManager.getLogger(ShowNotificationServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<NotificationDetail> notiDetails = dao.getNotification(user.getEmail());
            request.setAttribute("NOTIFICATION", notiDetails);
